...
def render_question(user_id, question_idx, last_code="", dhan_client_id=None, dhan_access_token=None, time_left=None):
    ...
    submit_button_text = "Attended Current Question Press Next →" if not is_last_question else "Submit Exam"
                                ...
                                <div class="editor-terminal-vertical-split">
                                    <div class="editor-slice" style="flex:0 0 70%;">
                                        ...
                                        <div class="buttons-row-new">
                                            <button id="runCodeBtn" type="button" onclick="runCode()" style="font-size:0.99em;padding:6px 18px;background:linear-gradient(91deg,#1e752e 0%,#38d28d 100%);color:#fff;font-weight:600;border-radius:5px;border:none;box-shadow:0 1.3px 5px #a2cfa9;cursor:pointer;letter-spacing:0.01em;transition:box-shadow 0.11s;outline:none;">&#9654; Run Code/Save Code</button>
